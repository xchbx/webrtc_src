...
class Conductor
  : public webrtc::PeerConnectionObserver,  // 创建PeerConnection对象需要设置进去
    public webrtc::CreateSessionDescriptionObserver,  // 创建或者获取sdp信息需要设置
    public PeerConnectionClientObserver,	// 连接服务器，获取对端的信息

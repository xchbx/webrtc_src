...
// Generic network manager interface. It provides list of local networks.
//
...
// Basic implementation of the NetworkManager interface that gets list of networks using OS APIs.
...
class Network {
 public:
  ...
  sigslot::signal1<const Network*> SignalTypeChanged;       // 网络类型变化事件

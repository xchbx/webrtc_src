...
// 实现webrtc::AudioSendStream::SendAudioData用于编码发送数据包
class AudioSendStream final : public webrtc::AudioSendStream,
                              public webrtc::BitrateAllocatorObserver,   
                              public webrtc::PacketFeedbackObserver {
 public:
  AudioSendStream(const webrtc::AudioSendStream::Config& config,                // rtp,rtcp 打包和发送相关配置
                  const rtc::scoped_refptr<webrtc::AudioState>& audio_state,    // 音频
                  rtc::TaskQueue* worker_queue,                                 // 任务队列
                  ProcessThread* module_process_thread,                         // 模块线程
                  RtpTransportControllerSendInterface* transport,
                  BitrateAllocator* bitrate_allocator,
                  RtcEventLog* event_log,
                  RtcpRttStats* rtcp_rtt_stats,                                 // rtcp统计处理

...
class VideoCaptureModule: public rtc::RefCountInterface {
 public:
  ...
  class DeviceInfo {
   public:
    ...
    virtual int32_t GetDeviceName(
        uint32_t deviceNumber,          // 索引值
        char* deviceNameUTF8,           // 设备名字
    ...
    // 获取指定deviceCapabilityNumber和deviceUniqueIdUTF8的能力信息
  ...
  // 设置回调函数，对象需要实现rtc::VideoSinkInterface接口
  ...
  // Start capture device(知道以何种能力采集数据)

...
// Callback class used for reporting 
// https://blog.csdn.net/shichaog/article/details/78257068
// VAD广泛应用于语音编码（网络/无线/有线传输），说话认识和语音识别（ASR，基于机器学习的方法，也是经过VAD标注后的语音数据用于训练的，
// 准确标注真实场景的带噪语音比较重要）。
...
// 音频数据编解码
// https://blog.csdn.net/wanghorse/article/details/46843271
class AudioCodingModule {
 ...
 public:
  ...
  // Returns number of supported codecs.  返回支持的音频编解码器数量
  //
  // Return value:
  ...
  ///////////////////////////////////////////////////////////////////////////
  // int32_t Codec()
  // Get supported codec with list number. 给定id获取编解码器信息
  //
  // Input:
  //   -list_id             : list number.(0到num-1 (num为NumberOfCodecs函数获取的数值))
  //
  // Output:
  ...
  ///////////////////////////////////////////////////////////////////////////
  // int32_t PlayoutData10Ms(    neteq处理，并解码，返回原始数据

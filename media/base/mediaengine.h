...
// 媒体引擎接口，支持音频引擎和视频引擎的操作，同时对两者数据做同步
...
// CompositeMediaEngine constructs a MediaEngine from separate voice and video engine classes.
// 将voice engine和video engine 组成MediaEngine
...
class CompositeMediaEngine : public MediaEngineInterface {
 public:
  ...
  CompositeMediaEngine(std::tuple<Args1...> first_args,
      ...
      : engines_(std::piecewise_construct,   // https://zh.cppreference.com/w/cpp/utility/piecewise_construct
                 std::move(first_args),
